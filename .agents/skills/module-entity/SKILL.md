---
name: module-entity
description: Criar, revisar ou orientar a implementação de entidades de módulo no padrão Genérico. Usar quando o pedido envolver "entidade", "entity", "module-entity", arquivos `*.entity.ts`, modelagem de regras de negócio com `Entity`, validação com `Result`, composição com Value Objects/Entidades aninhadas, ou criação/ajuste de testes de entidade.
---
