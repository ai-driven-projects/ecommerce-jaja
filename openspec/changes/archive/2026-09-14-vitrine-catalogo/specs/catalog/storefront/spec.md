...
**Reason**: A vitrine deixa de usar o catálogo local de 5 categorias e produtos fictícios e passa a exibir o catálogo real da API pública da loja.
**Migration**: Ver os requisitos "Catálogo a partir da API", "Categorias e subcategorias na vitrine" e "Página inicial da vitrine" desta capability, e a capability `catalog/storefront-api`. Os bairros agrupados por loja e o ETA continuam locais e passam a ser descritos em "Catálogo a partir da API".
