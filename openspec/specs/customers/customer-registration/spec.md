# Cadastro de Clientes (Customer Registration) Specification
...
- telefone celular com o DDD da cidade do endereço (11 em São Paulo, 21 no Rio de Janeiro);
- endereço em São Paulo/SP ou no Rio de Janeiro/RJ, em bairros da vitrine: a maioria nos atendidos pelas lojas do seed e alguns nos não atendidos.
