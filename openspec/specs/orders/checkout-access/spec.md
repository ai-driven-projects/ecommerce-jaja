...
Define como a rota pública `/checkout` da loja identifica o cliente antes do fechamento do pedido: o que exibe sem sessão e com sessão, a permanência na rota após entrar ou criar conta, o retorno à vitrine com bairro e categoria preservados e o resumo do pedido montado a partir do carrinho da conta. O fechamento do pedido em si (endereço, pagamento, criação do pedido) não faz parte desta capacidade.
